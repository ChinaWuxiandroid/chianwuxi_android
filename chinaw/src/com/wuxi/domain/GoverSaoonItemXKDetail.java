...
public class GoverSaoonItemXKDetail {
	...
	private String timelimit;// 限制工作日
	private String slbm;// 受理机关
	private String jdbm;// 决定机关
	private String linktel;// 联系电话
	private String bjtype;// 是否在即办理
	private String cert;// 是否发证
	private String charge;// 是否收费
	private String zxbl;
	private String otherAddr;
	private boolean iswssb;
	...
	public boolean isIswssb() {
		return iswssb;
	}

	public void setIswssb(boolean iswssb) {
		this.iswssb = iswssb;
	}
