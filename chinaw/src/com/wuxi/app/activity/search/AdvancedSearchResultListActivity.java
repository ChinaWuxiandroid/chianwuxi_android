...
public class AdvancedSearchResultListActivity extends BaseSlideActivity
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case RESULTS_LOAD_FAIL:
				...
				Toast.makeText(AdvancedSearchResultListActivity.this, tip,
	...
	public void loadSearchResults(final AdvancedSearchUtil searchUtil,
			final int pagenum) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				SearchService searchService = new SearchService(
						AdvancedSearchResultListActivity.this);
				try {
					searchResultWrapper = searchService
							.getAdvancedSearchResult(searchUtil,
									Constants.Urls.SEARCH_SITENAME, pagenum);
	...
	protected void findMainContentViews(View view) {
		searchUtil = (AdvancedSearchUtil) this.getIntent().getExtras()
				.get("searchUtil");
		findView(view);
