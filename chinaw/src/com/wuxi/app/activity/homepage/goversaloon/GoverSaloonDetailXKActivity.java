...
public class GoverSaloonDetailXKActivity extends BaseItemContentActivity
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case COMMIT_SUCCESS:
				...
				Toast.makeText(
					GoverSaloonDetailXKActivity.this, "提交成功",
			...
			case LOAD_ITEM_DETIAL_FAIL:
				...
				Toast.makeText(
					GoverSaloonDetailXKActivity.this, tip, Toast.LENGTH_SHORT)
						.show();
				break;
			}
		...
		new Runnable() {
			...
			public void run() {
				...
				GoverSaoonItemService goverSaoonItemService = new GoverSaoonItemService(
					GoverSaloonDetailXKActivity.this);
				try {
					goverSaoonItemDetail = goverSaoonItemService.getGoverItemXKDetailById(goverSaoonItem.getId());
			...
			public void run() {
				...
				try {
					GoversaoonOnlineASKDetail goversaoonOnlineDetail = goversaoonOnlineASKDetailService.commitGoversaoonOnlineASKDetail(
						...
						SystemUtil.getAccessToken(GoverSaloonDetailXKActivity.this));
