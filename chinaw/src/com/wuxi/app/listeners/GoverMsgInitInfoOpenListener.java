...
public class GoverMsgInitInfoOpenListener {
	...
	public static int getChannelFragmentType(Channel channel){
		...
		//政府采购
				...
				channleName.equals("政府采购目录")){
			fifterType=1;
		}
		//价格收费
		else if(channleName.equals("违法违规行为查处")||channleName.equals("部门行政事业性收费")){
			fifterType=1;
		}
		//统计信息
		...
		//社会管理
		//社会管理--房屋拆遷
		else if(channleName.equals("拆迁公告")||channleName.equals("补偿补助费用发放使用情况")||
